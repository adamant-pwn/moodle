...
$string['readablefiles'] = 'Export text attachments as readable UTF-8';
$string['readablefiles_help'] = 'Store suitable text attachments, such as CSS and JavaScript, as readable text instead of base64. Binary files and text that cannot be preserved exactly remain base64. Leave this disabled when importing into older Moodle versions, which do not support UTF-8 attachments.';
$string['unsupportedfileencoding'] = 'Unsupported file encoding in Moodle XML: {$a}';
