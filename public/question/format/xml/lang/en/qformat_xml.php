...
$string['legacyfiles'] = 'Use legacy-compatible attachment encoding';
$string['legacyfiles_help'] = 'Encode all attachments as base64 for import into older Moodle versions that do not support UTF-8 attachments. Otherwise, suitable text files are exported as readable text; binary files and text that cannot be preserved exactly still use base64.';
